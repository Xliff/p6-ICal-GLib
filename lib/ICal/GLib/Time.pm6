...
class ICal::GLib::Time is ICal::GLib::Object {
  ...
  method ICal::GLib::Object::Raw::Definitions::ICalTime
  { $!ict }
  ...
  method new_null_date {
    my $time = i_cal_time_new_null_date();

    $time ?? self.bless( :$time ) !! Nil
  }

  method new_null_time {
