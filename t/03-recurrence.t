...
#
# {
#   $recurrence.set-by-month_day(0, 5);
#   $recurrence.set-by-month_day(1, I_CAL_RECURRENCE_ARRAY_MAX);
#   is $recurrence.get-by-month_day(0),  5,                                 'Recurrence by-month_day at position 0 is 5';
#   is $recurrence.get-by-month_day(1),  I_CAL_RECURRENCE_ARRAY_MAX.Int,        'Recurrence by-month_day at position 1 is I_CAL_RECURRENCE_ARRAY_MAX (Int)';
#   my $array = $recurrence.get-by-month_day-array;
...
#   $array = (500, 501);
#   $recurrence.set-by-month_day-array;
#   is $recurrence.get-by-month_day(0),  500,                               'Recurrence .get-by-month_day index 0 is 500';
#   is $recurrence.get-by-month_day(1),  501,                               'Recurrence .get-by-month_day index 1 is 501';
#   is $recurrence.get-by-month_day(2),  I_CAL_RECURRENCE_ARRAY_MAX.Int,    'Recurrence .get-by-month_day index 2 is I_CAL_RECURRENCE_ARRAY_MAX   (Int)';
#   $array = $recurrence.get-by-month_day-array($array);
...
#
# {
#   $recurrence.set-by-year_day(0, 6);
#   $recurrence.set-by-year_day(1, I_CAL_RECURRENCE_ARRAY_MAX);
#   is $recurrence.get-by-year_day(0),   6,                                 'Recurrence by-year_day at position 0 is 6';
#   is $recurrence.get-by-year_day(1),   I_CAL_RECURRENCE_ARRAY_MAX.Int,        'Recurrence by-year_day at position 1 is I_CAL_RECURRENCE_ARRAY_MAX (Int)';
#   my $array = $recurrence.get-by-year_day-array;
...
#   $array = (600, 601);
#   $recurrence.set-by-year_day-array;
#   is $recurrence.get-by-year_day(0),   600,                               'Recurrence .get-by-year_day index 0 is 600';
#   is $recurrence.get-by-year_day(1),   601,                               'Recurrence .get-by-year_day index 1 is 601';
#   is $recurrence.get-by-year_day(2),   I_CAL_RECURRENCE_ARRAY_MAX.Int,    'Recurrence .get-by-year_day index 2 is I_CAL_RECURRENCE_ARRAY_MAX   (Int)';
#   $array = $recurrence.get-by-year_day-array($array);
...
#
# {
#   $recurrence.set-by-week_no(0, 7);
#   $recurrence.set-by-week_no(1, I_CAL_RECURRENCE_ARRAY_MAX);
#   is $recurrence.get-by-week_no(0),    7,                                 'Recurrence by-week_no at position 0 is 7';
#   is $recurrence.get-by-week_no(1),    I_CAL_RECURRENCE_ARRAY_MAX.Int,        'Recurrence by-week_no at position 1 is I_CAL_RECURRENCE_ARRAY_MAX (Int)';
#   my $array = $recurrence.get-by-week_no-array;
...
#   $array = (700, 701);
#   $recurrence.set-by-week_no-array($array);
#   is $recurrence.get-by-week_no(0),    700,                               'Recurrence .get-by-week_no index 0 is 700';
#   is $recurrence.get-by-week_no(1),    701,                               'Recurrence .get-by-week_no index 1 is 701';
#   is $recurrence.get-by-week_no(2),    I_CAL_RECURRENCE_ARRAY_MAX.Int,    'Recurrence .get-by-week_no index 2 is I_CAL_RECURRENCE_ARRAY_MAX   (Int)';
#   $array = $recurrence.get-by-week_no-array;
...
#
# {
#   $recurrence.set-by-set_pos(0, 8);
#   $recurrence.set-by-set_pos(1, I_CAL_RECURRENCE_ARRAY_MAX);
#   is $recurrence.get-by-set_pos(0),    8,                                 'Recurrence by-set_pos at position 0 is 8';
#   is $recurrence.get-by-set_pos(1),    I_CAL_RECURRENCE_ARRAY_MAX.Int,        'Recurrence by-set_pos at position 1 is I_CAL_RECURRENCE_ARRAY_MAX (Int)';
#   my $array = $recurrence.get-by-set_pos-array;
...
#   $array = (800, 801);
#   $recurrence.set-by-set_pos-array($array);
#   is $recurrence.get-by-set_pos(0),    800,                               'Recurrence .get-by-set_pos index 0 is 800';
#   is $recurrence.get-by-set_pos(1),    801,                               'Recurrence .get-by-set_pos index 1 is 801';
#   is $recurrence.get-by-set_pos(2),    I_CAL_RECURRENCE_ARRAY_MAX.Int,    'Recurrence .get-by-set_pos index 2 is I_CAL_RECURRENCE_ARRAY_MAX   (Int)';
#   $array = $recurrence.get-by-set_pos-array;
...
# for ^10 {
#   is $result[0],                     $start + $_* $sec-per-day,           ".expand_recur index $_ test passed";
# }
#
